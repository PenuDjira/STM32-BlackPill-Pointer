...
int main(void)
{
  ...
  // Raw pointer to RCC AHB1ENR register
  // Address: RCC base (0x40023800) + AHB1ENR offset (0x30)
  uint32_t *pRCC_AHB1ENR = (uint32_t*) 0x40023830;
  *pRCC_AHB1ENR |= (1U << 2);

  // Raw pointer to GPIOC MODER register
  // Address: GPIOC base (0x40020800) + MODER offset (0x00)
